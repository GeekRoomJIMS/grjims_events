        ...
        <div className="parent-schedule">
          ...
          <div className="timeline" id="timeline">
            ...
            <div className="container " style={{width:"45%"}}>
              <h2 className="container-title">Acceptance Mail to participents</h2>
              <h1 className="date">
                <div>
                  5th September 2024 
                  </div>
            ...
            <div className="container" id="timeline-container" style={{width:"45%"}}>
              ...
              <h2 className="container-title">Hack Vortex Offline Round</h2>
            ...
            <div className="container " style={{width:"45%"}}>
              ...
              <h2 className="container-title">Algo Hunts</h2>
              <span className="circle"></span>
            </div>

            <div className="container " style={{width:"45%"}}>
              <h2 className="container-title">kaggle Day</h2>
              <h1 className="date">
                <div>
                28th September 2024
                </div>
        ...
        <h1 className="timeh1">TimeLine</h1>
          ...
          <div className="timeline-mobile" id="timeline">
            <div className="container-mobile" id="timeline-container">
              ...
              <h2 className="container-title-mobile">Registration Start</h2>
            ...
            <div className="container-mobile" id="timeline-container-mobile">
              ...
              <h2 className="container-title-mobile">Hack vortex offline round</h2>
